...
function xterm_to_fg() {
    echo -en "\033[38;5;${1}m"
}

function xterm_to_bg() {
    echo -en "\033[48;5;${1}m"
}

function tfmt() {
    python_func -p colors.py tfmt "$@"
}

function color() {
    python_func -p colors.py color "$@"
}

function shades() {
    python_func -p colors.py shades "$@"
}

function colors() {
    python_func -p colors.py xterm_colors "$@"
}

fi # _REDSHELL_XTERM_COLORS
